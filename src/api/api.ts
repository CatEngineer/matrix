...
export class MxHttpClient {
    ...
    uploadContent(content: string, content_Type?: string | null | undefined, filename?: string | null | undefined): Promise<Anonymous78> {
        ...
        let options_: RequestInit = {
            ...
            method: "POST",
            headers: {
                "Content-Type": content_Type !== undefined && content_Type !== null ? "" + content_Type : "application/json",
                "Accept": "application/json"
            }
        };
...
/** Optional (default `b`) direction to return events from. If this is set to `f`, events will be returned in chronological order starting at `from`. If it is set to `b`, events will be returned in *reverse* chronological order, again starting at `from`. */
export type Dir2 = "b" | "f";

/** Optional (default `b`) direction to return events from. If this is set to `f`, events will be returned in chronological order starting at `from`. If it is set to `b`, events will be returned in *reverse* chronological order, again starting at `from`. */
export type Dir3 = "b" | "f";
...
export type Include = "all" | "participated";
...
/** The kind of rule */
export type Kind = "override" | "underride" | "sender" | "room" | "content";

/** The kind of rule */
export type Kind2 = "override" | "underride" | "sender" | "room" | "content";

/** The kind of rule */
export type Kind3 = "override" | "underride" | "sender" | "room" | "content";
...
/** The kind of rule */
export type Kind4 = "override" | "underride" | "sender" | "room" | "content";

/** The kind of rule */
export type Kind5 = "override" | "underride" | "sender" | "room" | "content";
...
/** The kind of rule */
export type Kind6 = "override" | "underride" | "sender" | "room" | "content";

/** The kind of rule */
export type Kind7 = "override" | "underride" | "sender" | "room" | "content";
...
export type Membership = "join" | "invite" | "knock" | "leave" | "ban";

/** The kind of membership to exclude from the results. Defaults to no filtering if unspecified. */
export type Not_membership = "join" | "invite" | "knock" | "leave" | "ban";
...
export type ReceiptType = "m.read" | "m.read.private" | "m.fully_read";
...
export type Set_presence = "offline" | "online" | "unavailable";
...
export type Body4Medium = "email" | "msisdn";

export type Body7Medium = "email" | "msisdn";
...
export type Body12Preset = "private_chat" | "public_chat" | "trusted_private_chat";

export type Body12Visibility = "public" | "private";
...
export type Body16Visibility = "public" | "private";

export type Body17Visibility = "private" | "public";
...
export type Body21Type = "m.login.password" | "m.login.token";

export type PresenceStatePresence = "online" | "offline" | "unavailable";
...
export type VersionAlgorithm = "m.megolm_backup.v1.curve25519-aes-sha2";

export type Version2Algorithm = "m.megolm_backup.v1.curve25519-aes-sha2";
...
export type Id_server_unbind_result = "no-support" | "success";

export type Id_server_unbind_result2 = "no-support" | "success";

export type Id_server_unbind_result3 = "success" | "no-support";
...
export type Presence2 = "online" | "offline" | "unavailable";
...
export type Algorithm = "m.megolm_backup.v1.curve25519-aes-sha2";

export type Algorithm2 = "m.megolm_backup.v1.curve25519-aes-sha2";
...
export type RoomInfoMembership = "invite" | "join" | "leave" | "ban";
...
export type RoomInfoVisibility = "private" | "public";
...
export type Filter3Event_format = "client" | "federation";
...
export type ThreepidsMedium = "email" | "msisdn";
...
export type Rooms2Membership = "invite" | "join" | "leave" | "ban";
...
export type Rooms2Visibility = "private" | "public";
...
export type Filter4Event_format = "client" | "federation";
...
export type Usage = "master" | "self_signing" | "user_signing";

export type Usage2 = "master" | "self_signing" | "user_signing";

export type Usage3 = "master" | "self_signing" | "user_signing";
...
export type Keys3 = "content.body" | "content.name" | "content.topic";

export type Room_eventsOrder_by = "recent" | "rank";
...
export type Usage4 = "master" | "self_signing" | "user_signing";

export type Usage5 = "master" | "self_signing" | "user_signing";

export type Usage6 = "master" | "self_signing" | "user_signing";
...
export type Group_byKey = "room_id" | "sender";
